...
- (void)setColorPicker:(RSColorPickerView*)cp {
    ...
    _m_imgMark.center = CGPointMake( _m_imgMark.center.x, [_colorPicker brightness] * self.frame.size.height );
}
...
- (void) touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    float val  = pt.y / self.frame.size.height;
    [_colorPicker setBrightness:val];
    _m_imgMark.center = CGPointMake( _m_imgMark.center.x, val * self.frame.size.height );
}
