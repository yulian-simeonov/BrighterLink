...
@interface TextAreaPropertyView()

@end

@implementation TextAreaPropertyView
...
- (void) awakeFromNib
{
    ...
    _m_txtFontColor.tag = 2; [_m_txtFontColor setUserInteractionEnabled:false];
    ...
    _m_txtFontSize.tag = 4; [_m_txtFontSize setDelegate:self];
    [_m_txtFontName setUserInteractionEnabled:false];

    [_m_txtBgImg setDelegate:self];  _m_txtBgImg.tag = 15;
...
- (void)textFieldDidEndEditing:(UITextField *)textField
{
    ...
    switch ( tag ) {
        ...
        case 3:
            ...
            break;
        case 4:
            title.size  =  [NSNumber numberWithDouble:[textField.text doubleValue]];
            break;
