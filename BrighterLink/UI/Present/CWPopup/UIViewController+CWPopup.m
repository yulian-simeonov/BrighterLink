...
- (void)presentPopupViewController:(UIViewController *)viewControllerToPresent type:(BOOL) bCenter animated:(BOOL)flag completion:(void (^)(void))completion {
    if (self.popupViewController == nil) {
        ...
        CGRect finalFrame = [self getPopupFrameForViewController:viewControllerToPresent type:bCenter];
        ...
        viewControllerToPresent.view.layer.zPosition = 20;
        ...
        if (self.useBlurForPopup) {
            ...
            if (UIDeviceOrientationIsPortrait([UIApplication sharedApplication].statusBarOrientation)) {
                ...
                fadeView.frame = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height);
            }
...
- (CGRect)getPopupFrameForViewController:(UIViewController *)viewController type:(BOOL) bCenter {
