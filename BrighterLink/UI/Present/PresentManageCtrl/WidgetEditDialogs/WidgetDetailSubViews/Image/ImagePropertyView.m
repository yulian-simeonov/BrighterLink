...
@interface ImagePropertyView()

@end

@implementation ImagePropertyView
...
- (IBAction) onFontName:(id)sender
{
    ...
    [_m_vFont setFrame:CGRectMake( _m_imgFontBg.frame.origin.x,  _m_imgFontBg.frame.origin.y + _m_imgFontBg.frame.size.height,  _m_vFont.frame.size.width, _m_vFont.frame.size.height)];
